...
from livekit.plugins import openai, deepgram, elevenlabs, silero, turn_detector, rag
...
# not used anymore probably - mov e t ohelpers
...
async def entrypoint(ctx: JobContext):
    ...
    # Ensure the initial system prompt is always included
    truncated_messages = [initial_ctx.messages[0]] + initial_ctx.messages[1:]
    ...
    # Update the chat context with truncated messages
    initial_ctx.messages = truncated_messages
    ...
    def on_user_speech_committed(msg: llm.ChatMessage):
        ...
        print(f"{msg.content} - user speech committed")
