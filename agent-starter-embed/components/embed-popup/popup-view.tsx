...
export const PopupView = ({
  ...
  const [chatOpen, setChatOpen] = useState(true); // Auto-open chat for chat-only mode
      ...
      <div className="relative flex h-full shrink-1 grow-1 flex-col">
        ...
        >
          <ActionBar
            ...
            controls={{
              microphone: false, // Hide microphone for chat-only mode
              camera: false, // Hide camera for chat-only mode
              screenShare: false, // Hide screen share for chat-only mode
              chat: true, // Keep chat visible
            }}
